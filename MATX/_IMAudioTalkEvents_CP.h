...
template<class T>
class CProxy_IMAudioTalkEvents :
	public IConnectionPointImplMT<T, &__uuidof(_IMAudioTalkEvents), CComDynamicUnkArray>
{
public:
	HRESULT Fire_GetState( LONG * state)
	{
		HRESULT hr = S_OK;
	...
	HRESULT Fire_GetString( BSTR str)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
